...
function setTable(datalist, flag){                //  html 테이블 만들기
    ...
    if(flag != 3){
        ...
        htmlString += '<tfoot><tr><th colspan="4"><button type="button" id="approve" class="btn">승인</button><button type="button" id="reject" class="btn cancel">미승인</button></th></tr></tfoot>';
        ...
        htmlString += '<tfoot><tr><th colspan="4"><button type="button" id="approve" class="btn">승인</button><button type="button" id="reject" class="btn cancel">미승인</button><button type="button" id="down2excel" class="btn">엑셀로 저장</button></th></tr></tfoot>';
        htmlString += '<tbody id="tableData">';
        $.each(datalist, function(idx, data){
